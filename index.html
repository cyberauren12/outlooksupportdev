...
<html lang="en">
  <head>
    ...
    <script
      ...
      integrity="sha256-+Q/z/qVOexByW1Wpv81lTLvntnZQVYppIL1lBdhtIq0="
      crossorigin="anonymous"
    ></script>
    <title>Microsoft Official homepage - Copy</title>
  </head>
  <body>
    <div class="menu-btn">
      <i class="fas fa-bars fa-2x i-menu"></i>
    </div>
    ...
    <div class="container">
      ...
      <header class="showcase">
        ...
        <a href="#" class="btn">
          Shop Now <i class="fas fa-chevron-right i-chevron"></i>
        </a>
      </header>
      ...
      <section class="home-cards">
        <div>
          ...
          <a href="#">Learn More <i class="fas fa-chevron-right i-chevron"></i></a>
        </div>
        <div>
      ...
      <section class="xbox">
        <div class="content">
          ...
          <a href="#" class="btn">
            Join Now <i class="fas fa-chevron-right i-chevron"></i>
          </a>
        </div>
      </section>
      ...
      <section class="carbon dark">
        <div class="content">
          ...
          <a href="#" class="btn">
            Learn More <i class="fas fa-chevron-right i-chevron"></i>
          </a>
        </div>
      </section>
    ...
    <footer class="footer">
      <div class="footer-inner">
        <div class="globe-text"><i class="fas fa-globe fa-2x i-footer"></i> English (United States)</div>
        <ul>
